...
app.post('/enviarFormulario', async (req, res) => {
  const email = req.body.fldVhfn3SbtLgHaJa;
  const mensaje = req.body.fldPYutyP0yvWs5WD;

  const url = 'https://api.airtable.com/v0/appoUjOHlojlQeOLg/tblTNuOnRXGRnQP3K';
  const airtableToken = '4bfd54b793a458392e0cf796ffc0bd53128b0afd8f36543dfd77071bc0fe0b07';
